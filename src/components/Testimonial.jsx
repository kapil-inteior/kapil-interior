  ...
  return (
    <div className="bg-[#1c1c1c] w-full">
      <div className="flex flex-col sm:flex-row w-full p-16">
        ...
        <div className="w-full sm:w-1/3 lg:w-1/4 bg-[#b2a089] flex items-center justify-center p-8 sm:p-12">
          <h2 className="text-white text-3xl sm:text-4xl font-light">Testimonials</h2>
        </div>
